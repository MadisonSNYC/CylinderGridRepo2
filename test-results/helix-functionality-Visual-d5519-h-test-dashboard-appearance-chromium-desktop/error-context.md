  ...
  - generic [ref=e1531]:
    - generic [ref=e1532] [cursor=pointer]:
      - generic [ref=e1533] [cursor=pointer]:
        ...
        - generic [ref=e1535] [cursor=pointer]: Excellent
    ...
    - generic [ref=e1547]:
      ...
      - generic [ref=e1553]:
        ...
        - generic [ref=e1555]: 0.00ms
      - generic [ref=e1556]:
        - generic [ref=e1557]: Cache
        - generic [ref=e1559]: 0%
      - generic [ref=e1561]:
        - generic [ref=e1562]: Memory
        - generic [ref=e1563]: 0.0KB
  - generic [ref=e1586]:
    - heading "Comprehensive Test Suite" [level=3] [ref=e1588]:
      - img [ref=e1589]
      - text: Comprehensive Test Suite
    - generic [ref=e1592]:
      - button "Start Comprehensive Test" [ref=e1593]:
        - img [ref=e1594]
        - text: Start Comprehensive Test
      - generic [ref=e1596]:
        - checkbox "Auto-advance phases" [ref=e1597]
        - generic [ref=e1598]: Auto-advance phases
  - generic [ref=e1599]:
    - generic [ref=e1601]:
      - generic [ref=e1602]:
        - img [ref=e1603]
        - generic [ref=e1605]: Test Dashboard
        - generic [ref=e1606]: DEV
      - button "+" [ref=e1607]
    - generic [ref=e1609]:
      - button "Run comprehensive test suite" [ref=e1610]:
        - img [ref=e1611]
        - text: Run Tests
      - button "Copy test report to clipboard" [disabled] [ref=e1613]:
        - img [ref=e1614]
        - text: Copy Report
      - button "Download test report as JSON file" [disabled] [ref=e1617]:
        - img [ref=e1618]
        - text: JSON
  - generic [ref=e1621]:
    - generic [ref=e1623]:
      - generic [ref=e1624]:
        - img [ref=e1625]
        - generic [ref=e1627]: Advanced Test Suite
        - generic [ref=e1628]: DEV
      - button "+" [ref=e1629]
    - generic [ref=e1632]:
      - button "Run advanced test suite" [ref=e1633]:
        - img [ref=e1634]
        - text: Run Advanced
      - button "Copy advanced test report to clipboard" [disabled] [ref=e1636]:
        - img [ref=e1637]
        - text: Copy Report
      - button "Download advanced test report as JSON file" [disabled] [ref=e1640]:
        - img [ref=e1641]
        - text: JSON
  - generic [ref=e1644]:
    - generic [ref=e1645]:
      - generic [ref=e1646]:
        - generic [ref=e1647]:
          - img [ref=e1648]
          - generic [ref=e1650]: Playwright Tests
          - generic [ref=e1651]: PRO
          - img [ref=e1652]
        - button "+" [ref=e1656]
      - generic [ref=e1658]: Connected
    - generic [ref=e1661]:
      - button "Run Playwright tests" [ref=e1662]:
        - img [ref=e1663]
        - text: Run Playwright
      - button "Copy Playwright test report to clipboard" [disabled] [ref=e1665]:
        - img [ref=e1666]
        - text: Copy Report
  - generic [ref=e1669]:
    - button "Hide comprehensive test suite panel" [ref=e1670]: Hide Comprehensive Test
    - button "Show aspect ratio test panel" [ref=e1671]: Show Aspect Test
    - button "Show test recorder panel" [ref=e1672]: Show Test Recorder
```